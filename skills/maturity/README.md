...
Evidence-first maintenance routines. Each one produces findings with repros, not opinions.

## Model-invoked

Model- or user-reachable (rich trigger phrasing so the model can reach for them).

- **[mutation-tester](./mutation-tester/SKILL.md)**: Run mutation testing and turn surviving mutants into targeted tests for the behavior they expose.
